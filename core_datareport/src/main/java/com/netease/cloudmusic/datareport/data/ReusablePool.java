...
public class ReusablePool {
    ...
    public static VTreeNode obtainVTreeNode(View view, boolean isVisible, boolean isVirtual){
        VTreeNode reusable = new VTreeNode(view, isVisible, isVirtual);
        return reusable;
    }
    ...
    public static void recycleVTree(VTreeNode vTree) {
    }
