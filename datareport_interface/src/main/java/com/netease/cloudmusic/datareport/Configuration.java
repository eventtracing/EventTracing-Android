...
public class Configuration {
    ...
    private final IDynamicParamsProvider mDynamicParamsProvider; //在主线程添加动态参数
    ...
    private final boolean isUIDebug;
    ...
    public static class Builder {
        ...
        private boolean isUIDebug = false;
        ...
        public Builder setUIDebug(Boolean uiDebug) {
            this.isUIDebug = uiDebug;
            return this;
        }
