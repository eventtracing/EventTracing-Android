...
public interface IDataReport extends IViewOperator {
    ...
    @Deprecated
    @MainThread
    void addEventCallback(IEventCallback callback);
     ...
     */
    @MainThread
    void addNodeEventCallback(INodeEventCallback callback);

    @MainThread
    void removeNodeEventCallback(INodeEventCallback callback);
     ...
     * 注册最叶子子节点发生变化的回调
     */
    void registerChildPageOidChangeCallback(IChildPageChangeCallback callback);
