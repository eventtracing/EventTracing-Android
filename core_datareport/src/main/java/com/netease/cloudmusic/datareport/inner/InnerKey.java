...
public class InnerKey {
     ...
     * 设置子页面的曝光是否产生refer
     */
    public static final String VIEW_GENERATE_REFER_ENABLE = "generate_refer_enable";

    /**
     * 设置子页面是否需要展示refer，以及需要展示的refer的类型
     * @see REFER_CONSUME_OPTION_EVENT
     * @see REFER_CONSUME_OPTION_SUB_PAGE
     */
    public static final String VIEW_REFER_CONSUME_OPTION = "refer_consume_option";

    /**
     * 只获取event的refer
     */
    public static final int REFER_CONSUME_OPTION_EVENT = 1 << 1;
    /**
     * 只获取subPage的曝光的refer
     */
    public static final int REFER_CONSUME_OPTION_SUB_PAGE = 1 << 2;
}