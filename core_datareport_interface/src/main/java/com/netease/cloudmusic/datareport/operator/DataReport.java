...
public class DataReport implements IDataReport {
    ...
    public String getMutableRefer() {
        if (dataReport != null) {
            return dataReport.getMutableRefer();
        }
        return "";
    }
    ...
    public IViewOperator deepCloneData(Object object) {
        if (dataReport != null) {
            dataReport.deepCloneData(object);
        }
        return this;
    }
    ...
    @Override
    public IViewOperator setVirtualParentPageNode(@NonNull Object view, String pageId, String identifier, @Nullable VirtualParentConfig config) {
        if (dataReport != null) {
            dataReport.setVirtualParentPageNode(view, pageId, identifier, config);
        }
        return this;
    }
    ...
    public IViewOperator setSubPageGenerateReferEnable(Object view, boolean enable) {
        if (dataReport != null) {
            dataReport.setSubPageGenerateReferEnable(view, enable);
        }
        return this;
    }
    ...
    public IViewOperator setSubPageConsumeReferOption(Object view, ReferConsumeOption option) {
        if (dataReport != null) {
            dataReport.setSubPageConsumeReferOption(view, option);
        }
        return this;
    }
    ...
    public void addEventCallback(IEventCallback callback) {
        if (dataReport != null) {
            dataReport.addEventCallback(callback);
        }
    }
    ...
    public void addNodeEventCallback(INodeEventCallback callback) {
        if (dataReport != null) {
            dataReport.addNodeEventCallback(callback);
        }
    }
    ...
    public void removeNodeEventCallback(INodeEventCallback callback) {
        if (dataReport != null) {
            dataReport.removeNodeEventCallback(callback);
        }
    }
    ...
    public void registerChildPageOidChangeCallback(IChildPageChangeCallback callback) {
        if (dataReport != null) {
            dataReport.registerChildPageOidChangeCallback(callback);
        }
    }
    ...
    public String getCompleteRefers() {
        if (dataReport != null) {
            return dataReport.getCompleteRefers();
        }
        return null;
    }
